...
export const toolsLocalArtifactPatterns = Object.freeze([
  defineProductPattern({
    ...
    exemplarRoutes: ["/patterns/tooldirectory/"],
  ...
  defineProductPattern({
    ...
    exemplarRoutes: ["/patterns/toolcard/"],
    adopterGuidance: guidance,
  ...
  defineProductPattern({
    ...
    exemplarRoutes: ["/patterns/localboundarybanner/"],
    adopterGuidance: guidance,
  ...
  defineProductPattern({
    ...
    exemplarRoutes: ["/patterns/outputartifactsummary/"],
    adopterGuidance: guidance,
